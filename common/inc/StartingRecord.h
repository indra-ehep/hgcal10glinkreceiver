#ifndef Hgcal10gLinkReceiver_StartingRecord_h
#define Hgcal10gLinkReceiver_StartingRecord_h
...
namespace Hgcal10gLinkReceiver {
  ...
  class StartingRecord : public Record<1> {
  ...
  public:
    ...
    void setHeader(uint32_t t=time(0)) {
      ...
      setState(RunControlFsmEnums::Starting);
      setLength();
      setUtc(t);
    }
    /*
    ...
    */
    void print(std::ostream &o=std::cout, std::string s="") {
      o << s << "StartingRecord::print()" << std::endl;
