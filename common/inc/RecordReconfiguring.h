#ifndef Hgcal10gLinkReceiver_RecordReconfiguring_h
#define Hgcal10gLinkReceiver_RecordReconfiguring_h
...
namespace Hgcal10gLinkReceiver {
  ...
  class RecordReconfiguring : public RecordT<10> {
  ...
  public:
    ...
    void setHeader(uint32_t t=time(0)) {
      setState(FsmState::Reconfiguring);
      setPayloadLength(2);
      setUtc(t);
    }

    bool valid() const {
      return validPattern() && state()==FsmState::Reconfiguring;
    }
    ...
    void print(std::ostream &o=std::cout, std::string s="") const {
      o << s << "RecordReconfiguring::print()" << std::endl;
