#ifndef Hgcal10gLinkReceiver_ConfiguringRecord_h
#define Hgcal10gLinkReceiver_ConfiguringRecord_h
...
namespace Hgcal10gLinkReceiver {
  ...
  class ConfiguringRecord : public Record<1> {
  ...
  public:
    ...
    void setHeader(uint32_t t=time(0)) {
      ...
      setState(RunControlFsmEnums::Configuring);
      setLength();
      setUtc(t);
    }
    /*
    ...
    */
    void print(std::ostream &o=std::cout, std::string s="") {
      o << s << "ConfiguringRecord::print()" << std::endl;
