...
namespace Hgcal10gLinkReceiver {
  ...
  const uint32_t FifoDaqLink0ShmKey(0xced0da00);
  const uint32_t FifoDaqLink1ShmKey(0xced0da01);
  const uint32_t FifoDaqLink2ShmKey(0xced0da02);
  ...
  const uint32_t ProcessorFastControlDataShmKey(FifoDaqLink2ShmKey);
  const uint32_t ProcessorDaqLink0FifoShmKey(FifoDaqLink0ShmKey);
  const uint32_t ProcessorDaqLink1FifoShmKey(FifoDaqLink1ShmKey);
  const uint32_t ProcessorDaqLink2FifoShmKey(ProcessorFastControlDataShmKey);
}
