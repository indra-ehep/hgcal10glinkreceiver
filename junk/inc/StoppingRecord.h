#ifndef Hgcal10gLinkReceiver_StoppingRecord_h
#define Hgcal10gLinkReceiver_StoppingRecord_h
...
namespace Hgcal10gLinkReceiver {
  ...
  class StoppingRecord : public Record<1> {
  ...
  public:
    ...
    void setHeader(uint32_t t=time(0)) {
      ...
      setState(RunControlFsmEnums::Stopping);
      setLength();
      setUtc(t);
    }
    /*
    ...
    */
    void print(std::ostream &o=std::cout, std::string s="") {
      o << s << "StoppingRecord::print()" << std::endl;
